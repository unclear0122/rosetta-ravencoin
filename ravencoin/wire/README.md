...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/HorizenOfficial/rosetta-zen/btcd/wire)
=======
...
```bash
$ go get -u github.com/HorizenOfficial/rosetta-zen/btcd/wire
```
