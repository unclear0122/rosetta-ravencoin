...
// Tx returns a wrapped transaction (ravenutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (ravenutil.Tx) for all
...
// instead provides easy access to wrapped versions (ravenutil.Tx) of them.
